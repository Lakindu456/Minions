...
function showResultBox(){
    ...
    if(userScore > 14){
        let scoreTag = '<span> and congrats!, You got <p>'+ userScore +'</p> out of <p>20</p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else if(userScore > 10){
        let scoreTag = '<span> and nice, You got <p>'+ userScore +'</p> out of <p> 20 </p></span>';
        scoreText.innerHTML = scoreTag;
    }
    else{
        let scoreTag = '<span> and sorry, You got <p>'+ userScore +'</p> out of <p> 20 </p></span>';
        scoreText.innerHTML = scoreTag;
    }
}
...
function queCounter(index){
    ...
    let totalQuescountTag = '<span><p>'+ index +'</p>of<p>'+ questions.length +'</p>Marks</span>';
